		...
		**/
		...
		draw = function(){
			...
			if(scene === 12){
				...
				textSize(height/32);
				text(name,width/2,height-height/32);
				noStroke();
				fill(255,255,255);
			...
			if(scene === 13){
				...
				text("Laboratory",width/4*2.5,height/8*0.5);
				text("Settings",width/4*3.5,height/8*0.5);
				text("Shipyard not developed in this version!",width/2,height/2);
				textSize(height/32);
				text(name,width/2,height-height/32);
				noStroke();
				fill(255,255,255);
			...
			if(scene === 14){
				...
				text("Laboratory",width/4*2.5,height/8*0.5);
				text("Settings",width/4*3.5,height/8*0.5);
				text("Laboratory not developed in this version!",width/2,height/2);
				textSize(height/32);
				text(name,width/2,height-height/32);
				noStroke();
				fill(255,255,255);
			...
			if(scene === 20){
				...
				if(mouseX < width/2+width/8 && mouseX > width/2-width/8 && mouseY < height/2+height/8+height/16+height/32 && mouseY > height/2+height/8+height/32 && mouseIsPressed && scene === 20) {
					scene = 1;
				}	
			}
		};
