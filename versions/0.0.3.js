    var sketchProc = function(processingInstance) {
     ...
     with (processingInstance) {	
		...
		**/
		...
		draw = function(){
			shipStrength = shipNum[1]*1 + shipNum[2]*5 + shipNum[3]*10 + shipNum[4]*25 + shipNum[5]*100;
			if(scene === 1){
				background(0,0,0);
				starscape(1);
				fill(128,128,128);
			...
			if(scene === 12){
				...
				starscape(2);
				textAlign(CENTER,CENTER);
				object("home",planetOccupied[0],width/16*6,height/16*13,width/24,100,90,110);
				object("[1] planet 1",planetOccupied[1],width/16*8,height/16*10,width/16,98,140,139);
				object("[2] planet 2",planetOccupied[2],width/16*13,height/16*10,width/12,30,17,68);
				object("[3] planet 3",planetOccupied[3],width/16*10,height/16*8,width/16,90,87,95);
				object("[4] planet 4",planetOccupied[4],width/16*11,height/16*5,width/8,187,130,110);
				object("[5] planet 5",planetOccupied[5],width/16*6,height/16*5,width/15,214,159,255);
				object("[6] planet 6",planetOccupied[6],width/16*4,height/16*7,width/11,255,97,92);
				object("[7] planet 7",planetOccupied[7],width/16*2,height/16*10,width/18,234,199,207);
				object("[8] planet 8",planetOccupied[8],width/16*11,height/16*13,width/9,57,76,32);
				stroke(255,0,0);
				fill(128,128,128);
			...
			if(scene === 20){
				...
				if(planetOccupied[0] === 1){
					if(shipStrength < 5){stroke(255,0,0);}
					if(shipStrength >= 5){stroke(0,255,0);} 
				...
				textSize(height/24);
				object("home",planetOccupied[0],width/4,height/2,width/6,100,90,110);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[0] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[0] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: n/a",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: n/a",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[0] === 1){
					scene = 30;
				}
			}
			if(scene === 21){
				...
				textSize(height/24);
				object("[1] planet 1",planetOccupied[1],width/4,height/2,width/6,98,140,139);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[1] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[1] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 5",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: easy",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
					scene = 12;
				}
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[1] === 1){
					scene = 12;
				}
			}
			if(scene === 22){
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[2] === 1 && planetOccupied[1] === 2){
					if(shipStrength < 7){stroke(255,0,0);}
					if(shipStrength >= 7){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[2] planet 2",planetOccupied[2],width/4,height/2,width/6,30,17,68);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[2] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[2] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 7",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: easy-medium",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
					scene = 12;
				}
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[2] === 1  && planetOccupied[1] === 2){
					scene = 32;
				}
			}
			if(scene === 23){
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[3] === 1 && planetOccupied[2] === 2){
					if(shipStrength < 10){stroke(255,0,0);}
					if(shipStrength >= 10){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[3] planet 3",planetOccupied[3],width/4,height/2,width/6,90,87,95);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[3] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[3] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 10",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: medium",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
					scene = 12;
				}
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[3] === 1  && planetOccupied[2] === 2){
					scene = 33;
				}
			}
			if(scene === 24){
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[4] === 1 && planetOccupied[3] === 2){
					if(shipStrength < 12){stroke(255,0,0);}
					if(shipStrength >= 12){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[4] planet 4",planetOccupied[4],width/4,height/2,width/6,187,130,110);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[4] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[4] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 12",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: medium",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[4] === 1 && planetOccupied[3] === 2){
					scene = 34;
				}
			}
			if(scene === 25){
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[5] === 1 && planetOccupied[4] === 2){
					if(shipStrength < 20){stroke(255,0,0);}
					if(shipStrength >= 20){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[5] planet 5",planetOccupied[5],width/4,height/2,width/6,214,159,255);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[5] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[5] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 20",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: medium-hard",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
					scene = 12;
				}
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[5] === 1 && planetOccupied[4] === 2){
					scene = 35;
				}
			}
			if(scene === 26){
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[6] === 1 && planetOccupied[5] === 2){
					if(shipStrength < 25){stroke(255,0,0);}
					if(shipStrength >= 25){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[6] planet 6",planetOccupied[6],width/4,height/2,width/6,255,97,92);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[6] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[6] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 25",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: medium-hard",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[6] === 1 && planetOccupied[5] === 2){
					scene = 36;
				}
			}if(scene === 27){
				// [7] planet GUI
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[7] === 1 && planetOccupied[6] === 2){
					if(shipStrength < 35){stroke(255,0,0);}
					if(shipStrength >= 35){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[7] planet 7",planetOccupied[7],width/4,height/2,width/6,234,199,207);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[7] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[7] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 35",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: hard",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
					scene = 12;
				}
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[7] === 1 && planetOccupied[6] === 2){
					scene = 37;
				}
			}if(scene === 28){
				// [8] planet GUI
				...
				fill(64,64,64);
				rect(width/16*8,height/16*11,width/8,height/16);
				if(planetOccupied[8] === 1 && planetOccupied[7] === 2){
					if(shipStrength < 50){stroke(255,0,0);}
					if(shipStrength >= 50){stroke(0,255,0);} 
					rect(width/16*11,height/16*11,width/8,height/16);
				}
				noStroke();
				fill(255,0,0);
				...
				textSize(height/24);
				object("[8] planet 8",planetOccupied[8],width/4,height/2,width/6,57,76,32);
				textAlign(LEFT,CENTER);
				noStroke();
				fill(255,255,255);
				if(planetOccupied[8] === 1){text("Status: Occupied",width/2,height/16*6);}
				if(planetOccupied[8] === 2){text("Status: Taken",width/2,height/16*6);}
				text("recommended fleet strength: 50",width/2,height/16*7);
				text("your fleet strength: "+shipStrength,width/2,height/16*8);
				text("difficulty: hard-insane",width/2,height/16*9);
				textAlign(CENTER,CENTER);
				if(mouseX < width/4*1 && mouseX > width/4*0 && mouseY < height/8 && mouseY > 0 && mouseIsPressed) {
					scene = 12;
				}
				...
				if(mouseX < width/16*13 && mouseX > width/16*11 && mouseY < height/16*12 && mouseY > height/16*11 && mouseIsPressed && planetOccupied[8] === 1 && planetOccupied[7] === 2){
					scene = 38;
				}
			}
			if(scene === 40){
